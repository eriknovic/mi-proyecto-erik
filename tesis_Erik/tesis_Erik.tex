...
{% contenido de la etiqueta
 ...
 \Large\chaptertitlename\ % "Cap’tulo" o "ApŽndice" en tama–o \Large en lugar de \Huge
 \Large\thechapter} % nœmero de cap’tulo en tama–o \Large
{0mm} % espacio m’nimo entre etiqueta y cuerpo
{\filleft} % texto del cuerpo alineado a la derecha
[\vspace{0.5mm} \bigrule] % despuŽs del cuerpo, dejar espacio vertical y trazar l’nea horizontal gruesa
\pagestyle{fancy}
\fancyhf{}
...
\fancyhead[RO,LE]{\thepage} % Nœmeros de p‡gina en las esquinas de los encabezados
