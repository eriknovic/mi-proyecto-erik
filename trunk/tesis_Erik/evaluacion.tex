...
La \textit{integración semántica de los recursos} es el proceso de búsqueda y recuperación de información en un \textit{grafo de conocimiento (ontología)}. Esta \textit{integración semántica} depende del modelo que se utiliza en el motor de consulta. Por un lado, un motor al emplear un modelo de conocimiento explícito (sin inferencia), puede recuperar todos los recursos para una consulta, en el mejor de los casos. 


%%%% Planteamiento son las razones que originan la necesidad de investigar.
