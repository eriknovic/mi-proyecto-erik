...
Los sujetos de nuestra experimentación son un conjunto de personas, documentos y archivos multimedia que son generados artificialmente. Esta generación artificial consiste en dos actividades: 1) la asignación de un identificador URI para una serie de \textit{recursos de información} ficticios, así como 2) la generación de tripletas RDF para estos recursos con base en las propiedades de nuestra ontología y datos aleatorios. La finalidad del uso de \textit{información simulada} es tener rápidamente un volumen grande de datos y ver que Jena soporta esta escala de datos para nuestros ABox.
